...
const MONGODB_URI = 'mongodb+srv://admin:admin@slbarkcluster.x3bbi.mongodb.net/SiteDatabase?retryWrites=true&w=majority';
const option =  {
...
app.use((req, res, next) => {
    res.header("Access-Control-Allow-Origin", "*");//for better data communication
